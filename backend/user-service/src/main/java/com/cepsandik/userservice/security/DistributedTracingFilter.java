...
/**
 * Filter responsible for populating the MDC (Mapped Diagnostic Context) with 
 * distributed tracing information from request headers.
 */
@Component
...
public class DistributedTracingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            // Populate MDC with context from headers
            ...
            // Always clear MDC to prevent leakage between threads
            MDC.clear();
        }
    }
