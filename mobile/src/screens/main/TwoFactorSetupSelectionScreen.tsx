            ...
            <View style={tw`flex-1 w-full flex-col shadow-2xl overflow-hidden`}>
                ...
                <View style={tw`flex-col flex-1`}>
                    ...
                    <View style={tw`px-6 py-10 flex-col items-center`}>
                        <View style={tw`w-24 h-24 bg-[#1162d4]/10 rounded-full flex items-center justify-center mb-6`}>
                    ...
                    <View style={tw`flex-col gap-4 p-6`}>
                        ...
                        <TouchableOpacity
                            style={tw`group relative flex-row items-start rounded-xl border-2 border-[#1162d4] bg-[#1162d4]/5 p-5`}
                            activeOpacity={0.8}
                    ...
                    <View style={tw`mt-auto p-6`}>
                        ...
                        <TouchableOpacity
                            style={tw`w-full bg-[#1162d4] flex-row items-center justify-center gap-2 py-4 rounded-xl shadow-sm`}
