        ...
        <View style={tw`flex-1 bg-[#f6f7f8]`}>
            ...
            <View style={tw`flex-row items-center justify-between px-5 pt-14 pb-4 bg-white border-b border-slate-100 z-20`}>
                <View style={tw`flex-row items-center gap-3`}>
                    ...
                    <View>
                        <Text style={tw`text-xs font-medium text-slate-500`}>{t('auth.login.welcomeBack')}</Text>
            ...
            >
                ...
                <View style={tw`px-5`}>
                    <View style={tw`flex-row items-center gap-2 bg-[#1162d4]/10 px-3.5 py-1.5 rounded-full self-start border border-[#1162d4]/20 shadow-sm`}>
                        ...
                        <Text style={tw`text-xs font-semibold tracking-wide uppercase text-[#1162d4]`}>{t('home.securedBy')}</Text>
                    </View>
                </View>
                ...
                <View style={tw`flex-col gap-4`}>
                    <View style={tw`flex-row items-center justify-between px-5`}>
                        <Text style={tw`text-xl font-bold text-slate-900`}>{t('home.activeElections')}</Text>
                        <TouchableOpacity onPress={() => navigation.navigate('Communities')} activeOpacity={0.6}>
                            <Text style={tw`text-sm font-semibold text-[#1162d4]`}>{t('home.seeAll')}</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={tw`px-5 pb-2 gap-4`}>
                        {isLoading ? (
                            ...
                            <View style={tw`w-[280px] bg-white rounded-2xl p-5 shadow-sm border border-slate-100 flex-col gap-3 justify-center items-center h-44`}>
                                ...
                                <Text style={tw`text-slate-500 font-medium`}>{t('home.noActive')}</Text>
                            </View>
                        ) : (
                                ...
                                <View key={poll.electionId} style={tw`w-[280px] bg-white rounded-2xl p-5 shadow-sm border border-slate-100 flex-col relative overflow-hidden h-44`}>
                                    ...
                                    <View style={tw`flex-row justify-between items-start mb-3`}>
                                        <View style={tw`flex-row items-center gap-1.5 px-2.5 py-1 rounded-md bg-green-100`}>
                                            ...
                                            <Text style={tw`text-[10px] font-bold uppercase tracking-wider text-green-700`}>{t('home.live')}</Text>
                                        </View>
                                    ...
                                    <View style={tw`flex-1`}>
                                        ...
                                        <Text style={tw`text-xs text-slate-500 font-medium`} numberOfLines={1}>{t('home.community')}: {poll.communityId}</Text>
                                    </View>
                                    ...
                                    <View style={tw`mt-auto`}>
                                        ...
                                        >
                                            ...
                                            <Text style={tw`text-white text-sm font-semibold`}>{t('home.vote')}</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            ))
                ...
                <View style={tw`px-5 mt-2`}>
                    <Text style={tw`text-xl font-bold text-slate-900 mb-4`}>{t('home.recentResults')}</Text>
                    <View style={tw`flex-col gap-3`}>
                        {isLoading ? (
                            ...
                            <View style={tw`bg-white rounded-2xl p-6 shadow-sm border border-slate-100 items-center justify-center gap-2`}>
                                ...
                                <Text style={tw`text-slate-500 text-sm font-medium`}>{t('home.noRecentResults')}</Text>
                            </View>
                        ) : (
                                        ...
                                        <View style={tw`flex-col flex-1 pr-2`}>
                                            ...
                                            <View style={tw`flex-row items-center gap-2`}>
                                                <View style={tw`flex-row items-center gap-1`}>
                                                    ...
                                                    <Text style={tw`text-xs font-semibold text-slate-700`}>{t('home.voteCount', { count: result.totalVotes || 0 })}</Text>
                                                </View>
                                                <Text style={tw`text-xs text-slate-400`}>•</Text>
                                                <Text style={tw`text-xs font-medium text-slate-500`}>{new Date(result.endTime).toLocaleDateString(language === 'en' ? 'en-US' : 'tr-TR')}</Text>
                                            </View>
                                        </View>
                                    </View>
